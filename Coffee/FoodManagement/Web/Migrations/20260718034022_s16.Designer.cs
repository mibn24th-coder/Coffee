            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("64c4cf9d-fe70-4459-aeef-bcffe913981a"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 18, 10, 40, 17, 921, DateTimeKind.Local).AddTicks(4001),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 18, 10, 40, 17, 921, DateTimeKind.Local).AddTicks(4005),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 18, 10, 40, 17, 921, DateTimeKind.Local).AddTicks(4008),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 18, 10, 40, 17, 921, DateTimeKind.Local).AddTicks(4012),
                            Name = "Article",
                            ParentId = new Guid("f3dadf45-7db1-4ec9-89bc-f29eed14d099")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 18, 10, 40, 17, 921, DateTimeKind.Local).AddTicks(4015),
                            Name = "Product",
                            ParentId = new Guid("f3dadf45-7db1-4ec9-89bc-f29eed14d099")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 18, 10, 40, 17, 921, DateTimeKind.Local).AddTicks(3954),
