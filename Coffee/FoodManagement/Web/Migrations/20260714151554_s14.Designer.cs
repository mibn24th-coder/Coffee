            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea5516da-ee93-4658-ac7a-f5b5f6372cb6"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 14, 22, 15, 53, 83, DateTimeKind.Local).AddTicks(4987),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 14, 22, 15, 53, 83, DateTimeKind.Local).AddTicks(4996),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 14, 22, 15, 53, 83, DateTimeKind.Local).AddTicks(5003),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 14, 22, 15, 53, 83, DateTimeKind.Local).AddTicks(5009),
                            Name = "Article",
                            ParentId = new Guid("f3dadf45-7db1-4ec9-89bc-f29eed14d099")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 7, 14, 22, 15, 53, 83, DateTimeKind.Local).AddTicks(5014),
                            Name = "Product",
                            ParentId = new Guid("f3dadf45-7db1-4ec9-89bc-f29eed14d099")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 14, 22, 15, 53, 83, DateTimeKind.Local).AddTicks(4917),
