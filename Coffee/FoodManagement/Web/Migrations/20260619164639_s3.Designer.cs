            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9d4931b5-9afb-4a7e-875f-e7dc86b47e24"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 19, 23, 46, 34, 954, DateTimeKind.Local).AddTicks(1211),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 6, 19, 23, 46, 34, 954, DateTimeKind.Local).AddTicks(1213),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 6, 19, 23, 46, 34, 954, DateTimeKind.Local).AddTicks(1216),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 6, 19, 23, 46, 34, 954, DateTimeKind.Local).AddTicks(1219),
                            Name = "Article",
                            ParentId = new Guid("f3dadf45-7db1-4ec9-89bc-f29eed14d099")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("98d64f50-d8ce-4c84-90cc-4131af413f2a"),
                            CreatedOn = new DateTime(2026, 6, 19, 23, 46, 34, 954, DateTimeKind.Local).AddTicks(1222),
                            Name = "Product",
                            ParentId = new Guid("f3dadf45-7db1-4ec9-89bc-f29eed14d099")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 19, 23, 46, 34, 954, DateTimeKind.Local).AddTicks(1177),
